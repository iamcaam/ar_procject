       ...
       /******bypass SSL 網頁認證問題,系統SSL之Certification key非信任組織發行*************/
        ...
        try {
	     ...
	     conn.setRequestProperty("Accept", "application/json"); //設置接收數據格式
            ...
            conn.setConnectTimeout(20000); // 2017.09.18 william 錯誤修改(1)-IP Port例外處理 // 2017.11.24 william 單一帳號多個VD登入            
            conn.setReadTimeout(10000); // 2017.09.18 william 錯誤修改(1)-IP Port例外處理   // 2017.11.24 william 單一帳號多個VD登入            
