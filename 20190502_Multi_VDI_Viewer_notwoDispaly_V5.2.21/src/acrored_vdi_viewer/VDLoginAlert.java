...
public class VDLoginAlert {    
    ...
    public VDLoginAlert(Map<String, String> LangMap){
        WordMap=LangMap;
    }
    
    /****************跳出警告訊息:401 403 404*******************/
    public void VDMLoginAlertChange(int conn, Stage MainStage){
        if(conn!=0&&conn!=200) { //  2017.09.18 william 錯誤修改(4) 其他未知的錯誤      
            if("English".equals(WordMap.get("SelectedLanguage"))){
                ...
                if(conn == 401){
                    ...
                    alert.setTitle(WordMap.get("ManageVD_Title"));
                    ...
                    /*
                    //for XP-Dialog
                    alert.getDialogPane().setMinSize(620,120);
                    alert.getDialogPane().setMaxSize(620,120); 
                    */
    ...
    public void VDMLtestErrorAlert(Stage MainStage){        
        if("English".equals(WordMap.get("SelectedLanguage"))){
            ...
            alert_error.setContentText(
//                    WordMap.get("WW_Header")+" ： "+WordMap.get("Message_Error_VM_IP_02")+"\n"                                            
//                +"\n"+WordMap.get("Message_Suggest")+" ： "+"\n"
