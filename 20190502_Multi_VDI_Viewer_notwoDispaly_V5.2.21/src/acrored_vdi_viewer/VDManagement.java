...
public final class VDManagement {
   ...
   // private TableView table = new TableView();
    ...
    // public VDManagement(Stage primaryStage, Map<String, String> LangMap, String AccountName, String VDName, String suspend, String Satus, String VDOnline, String CTime, String desc, String IPAddr, String vdid, String IPPort ){ // 2017.08.10 william IP增加port欄位，預設443
...
//         Desc            = desc;        //  備註
        ...
        */
        ...
        //NameCol1.setStyle("-fx-alignment: CENTER-LEFT;");
         ...
         NameCol5.setMinWidth(150);
         //NameCol5.setMaxWidth(150);
...
//        });
        ...
        */
        ...
        //表格
         ...
         Button Confirm=new Button("    "+WordMap.get("Exit")+"    ");
        ...
        Bounds rootBounds = secondScene.getRoot().getLayoutBounds();
        
        // 2018.01.12 william 雲桌面管理 畫面大小處理
        if (currentScreenX <= 1280.0 && currentScreenY <= 1024.0) {
            secondStage.setX(primaryStage.getX() + (mainBounds.getWidth() - 950 ) / 2);  //5.7
            secondStage.setY(primaryStage.getY() + (mainBounds.getHeight() - 545 ) / 2);  //5
        } else {        
            secondStage.setX(primaryStage.getX() + (mainBounds.getWidth() - 1264 ) / 2);  //5.7
            secondStage.setY(primaryStage.getY() + (mainBounds.getHeight() - 574 ) / 2);  //5    
        }                
        ...
        //secondStage.setTitle(WordMap.get("ManageVD"));           
...
//        System.out.println(" rootBounds.getWidth() :: "+secondStage.getWidth()+"\n");
//        System.out.println(" rootBounds.getHeight() :: "+secondStage.getHeight()+"\n");    
    ...
    private Callback<TableColumn<Person, String>, TableCell<Person, String>> getCustomCellFactory(final String color) {
     ...
     public void ChangeLabelLang(Label title, TableColumn tc00, TableColumn tc01, TableColumn tc02, TableColumn tc03, TableColumn tc04, TableColumn tc05, TableColumn tc06, TableColumn tc07, TableColumn tc08){
        ...
        if("English".equals(WordMap.get("SelectedLanguage"))){
            title.setStyle("-fx-font-family:'Ubuntu'; -fx-text-fill: white; "); //-fx-font-size: 17px;  Ubuntu; Liberation Serif;
            tc01.setStyle ("-fx-font-family:'Ubuntu';");
            tc02.setStyle ("-fx-font-family:'Ubuntu';");
            tc03.setStyle ("-fx-font-family:'Ubuntu';");
            tc04.setStyle ("-fx-font-family:'Ubuntu';");
            tc05.setStyle ("-fx-font-family:'Ubuntu';");
            tc06.setStyle ("-fx-font-family:'Ubuntu';");
            tc07.setStyle ("-fx-font-family:'Ubuntu';");
            tc08.setStyle ("-fx-font-family:'Ubuntu';");
        }         
         ...
         /******下面 若無法讀取'標楷體'中文字型 ,則自動讀去下一個DFKai-SB英文字型*******/         
            ...
            tc03.setStyle ("-fx-font-family: 'Droid Sans Fallback';  ");
            ...
            tc07.setStyle ("-fx-font-family: 'Droid Sans Fallback';  ");
            tc08.setStyle ("-fx-font-family: 'Droid Sans Fallback';  ");
