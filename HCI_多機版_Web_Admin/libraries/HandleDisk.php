		...
		if(rtn == 0){			
			foreach ($outputCmd as $value) {
				...
				if(strlen($value['speed']) > 0)
					$speed = 'SATA '.$value['CurrentSpeed'].' Gb/s';		
			...
			//For Test
			// $output[] = array("Slot"=>2,"Status"=>$this->diskStateEnum['Unused'],"Vendor"=>$value['Vendor'],"DiskName"=>'',"Capacity"=>100,"Model"=>'',"Firmware"=>'',"Speed"=>'',"DevID"=>'');
			// $output[] = array("Slot"=>3,"Status"=>$this->diskStateEnum['Unused'],"Vendor"=>$value['Vendor'],"DiskName"=>'',"Capacity"=>100,"Model"=>'',"Firmware"=>'',"Speed"=>'',"DevID"=>'');
			// $output[] = array("Slot"=>4,"Status"=>$this->diskStateEnum['Unused'],"Vendor"=>$value['Vendor'],"DiskName"=>'',"Capacity"=>100,"Model"=>'',"Firmware"=>'',"Speed"=>'',"DevID"=>'');
			// $output[] = array("Slot"=>5,"Status"=>$this->diskStateEnum['Unused'],"Vendor"=>$value['Vendor'],"DiskName"=>'',"Capacity"=>100,"Model"=>'',"Firmware"=>'',"Speed"=>'',"DevID"=>'');
			// $output[] = array("Slot"=>6,"Status"=>$this->diskStateEnum['Unused'],"Vendor"=>$value['Vendor'],"DiskName"=>'',"Capacity"=>100,"Model"=>'',"Firmware"=>'',"Speed"=>'',"DevID"=>'');
		}	
	}
