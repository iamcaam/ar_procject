var LanguageStr_Service =
{
    ...
    Service_SS_Schedule_title : "SnapShot Schedule Setting",
    ...
    Service_BK_Schedule_title : "Backup Schedule Setting",    

    Service_CheckBackupState0 : "Unformat",
    Service_CheckBackupState1 : "Unformat",
    Service_CheckBackupState2 : "The backup version is different,You have to format Storage",
    Service_CheckBackupState3 : "This iSCSI LUN was used by another HCI Host. Do you want to adopt it?",
    Service_CheckBackupState4 : "",        
    Service_CheckBackupState5 : "Unformat",
    ...
    Backup_FormatAsk : "Are you sure to formatting?",
    CheckBackupLUN_failure : "Failure",
    ...
    BackupMgt_text_Dot : ".",
    Schedule_Create_Fail : "Warning: Schedule name can not 『blank』 or 『repeat』!"
}
