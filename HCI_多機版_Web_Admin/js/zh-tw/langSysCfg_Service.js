var LanguageStr_Service =
{
    ...
    Service_SS_Schedule_title : "快照排程設定",
    ...
    Service_BK_Schedule_title : "備份排程設定",

    Service_CheckBackupState0 : "未格式化",
    Service_CheckBackupState1 : "未格式化", // 格式化過但無備份過
    Service_CheckBackupState2 : "備份版本不同，格式化才能使用", // 格式化過但備份版本不同
    Service_CheckBackupState3 : "此iSCSI LUN已經被其他超融合主機使用過，請問是否採用?",
    Service_CheckBackupState4 : "",   // 格式化過但備份資料與儲存UUID相同
    Service_CheckBackupState5 : "未格式化", // 格式化過但無備份版本與UUID
    ...
    Backup_FormatAsk : "您確定格式化嗎?",
    CheckBackupLUN_failure : "失敗",
    BackupLUN_disconnect : "關閉連線",
    BackupLUN_OnlineCheck : "連線中",
    BackupLUN_OfflineCheck : "斷線中",
    ...
    BackupMgt_text_Dot : "。",
    Schedule_Create_Fail : "警告：檢查名稱是否為空白或是重複!"
}