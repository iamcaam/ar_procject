...
var VMClass = function(name,cpu_util,mem_util,state,seed,seed_src,desc,type,create_time,online,state_display,suspend,ram,vdid,allsize){
    this.name = name;
...
var VDStandbyJobsVMClass = function(vdid,userid,vdname,ram,suspend,desc,online,state,create_time,modify_time) {
    this.vdid = vdid;
    this.userid = userid;
    this.vdname = vdname;
    this.ram = ram;
