...
public class LoginAlert {
            ...
            if("English".equals(WordMap.get("SelectedLanguage"))){
                ...
                if(conn == 401){
                    ...
                    if(!GB.winXP_ver) {
                        ...
                        //for XP-Dialog
                        alert.getDialogPane().setMinSize(570,Region.USE_PREF_SIZE);
                        alert.getDialogPane().setMaxSize(570,Region.USE_PREF_SIZE);                    
                    }
    ...
    public void SetVDOnline_AlertChangeLang(int conn){
        if(conn!=0&&conn!=200) { //  2017.09.18 william 錯誤修改(4) 其他未知的錯誤 
            if("English".equals(WordMap.get("SelectedLanguage"))){
    ...
    public void LogintestErrorAlert(){        
        if("English".equals(WordMap.get("SelectedLanguage"))){
